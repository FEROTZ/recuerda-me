                    ...
                    <form class="flex items-center space-x-6">
                        <div class="p-8">
                            <div class=" flex items-center shrink-0 p-8">
                                <img class="h-16 w-16" src="{{ asset('resources/landing-assets/images/banner/shape/banner 1.png')}}" alt="About">
                            </div>
                            <label class="block">
                            ...
                            <div class="flex items-center space-x-4 p-2">
                                <a href="#victorModal" role="button" class="btn btn-large btn-primary" data-toggle="modal" required>Cargar Nota</a> 
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <p>¿Seguro que quieres guarar este vide?</p>
                                                    </div>
                            ...
                            <div class="p-8">
                                <div class=" flex items-center shrink-0 p-8">
                                    <img class="h-16 w-16" src="{{ asset('resources/landing-assets/images/banner/shape/banner 2.png')}}" alt="About">
                                </div>
                                <label class="block">
                                        ...
                                        <div id="victorModal" class="modal fade">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                                                        <button type="button" class="btn btn-danger file ile:to-zinc-900 file:text-zinc-700
                                                        hover:file:bg-zink-100">Eliminar</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
